...
function cuentoElementos(array) {
   ...
   let mayorA18 = array.filter(n => n > 18);
...
function mayorACien(array) {
   ...
   // Tu código:
let hundredPlus = [] = array.filter(num => num > 100)
return hundredPlus;
